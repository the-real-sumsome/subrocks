...
CREATE TABLE `users` (
  ...
  `layout` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_as_cs NOT NULL DEFAULT '1',
  `cooldown_comment` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `upload_cooldown` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `border_color` varchar(255) COLLATE utf8mb4_0900_as_cs NOT NULL DEFAULT '#000',
  `country` varchar(255) COLLATE utf8mb4_0900_as_cs NOT NULL DEFAULT 'None',
  `website` varchar(64) COLLATE utf8mb4_0900_as_cs NOT NULL DEFAULT '',
  `custom_header` varchar(255) COLLATE utf8mb4_0900_as_cs NOT NULL DEFAULT '',
